...
syn keyword jsonNull      curl first second output1 output2 rerun_ok affirm grammar
syn keyword jsonNull      sweep tempfile proceed skip stop notify test_empty csv
syn keyword jsonNull      columns size gravity selectpics modifypics renamepics
syn keyword jsonNull      height width
